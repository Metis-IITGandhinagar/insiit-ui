...
class _BusPageStandaloneState extends State<BusPageStandalone> {
  ...
  bool townsFetched = false; // Add a flag to track whether towns are fetched
  ...
  void fetchTowns() async {
    Response response = await get(
        Uri.parse('http://10.7.17.57:3000/api/towns'));
  ...
  void search() async {
    ...
    String url =
        'http://10.7.17.57:3000/api/search?source=$src&destination=$des';
